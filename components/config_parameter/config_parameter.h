...
#define TTS_CACHE_PARTITION   "storage"       // partition label (NVS, ~5 MB)
#define TTS_CACHE_NAMESPACE   "tts_cache"     // namespace within that partition
#define TTS_CACHE_MAX_ENTRY_BYTES (24 * 1024)
#define ENABLE_TTS_CACHE 1 // bật cache TTS trong NVS (cẩn thận với lỗi khi NVS đầy)
...
#define MQTT_BROKER_URL "broker.chtlab.us,1883"
...
#define GEN_SUB_TOPIC "ESP32/sub"
#define PRV_SUB_TOPIC "ESP32/sub_v2"
